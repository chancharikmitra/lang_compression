...
sys.path.append('/home/chancharikm/virtex')
...
def main(_A: argparse.Namespace):
    ...
    #fix data_root issue later
    #data_root = _A.data_root
    #if data_root is None:
    data_root  = os.path.join(_C.DATA.ROOT, "val2017")

    val_dataloader = DataLoader(
        ImageDirectoryDataset(data_root),
    ...
    for name, param in model.named_parameters():
        if "encoder" in name:
            ...
            print("Frozen Encoder in eval_captioning: ", name)
